...
import com.example.tenantManagementService.entity.Tenant;
import com.example.tenantManagementService.repositories.TenantRepository;
import com.example.tenantManagementService.util.EncryptionService;
...
public class TenantManagementServiceImpl implements TenantManagementService {
    ...
    public void createTenant(String tenantId, String db, String password) throws Exception {
        ...
        if (!db.matches(VALID_DATABASE_NAME_REGEXP)) {
            throw new Exception("Invalid db name: " + db);
        }
